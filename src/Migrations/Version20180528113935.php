 ...
 */
class Version20180528113935 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE milestone ADD user_id INT DEFAULT NULL, ADD is_public TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE milestone DROP user_id, DROP is_public');
    }
}
