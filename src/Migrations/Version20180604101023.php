 ...
 */
class Version20180604101023 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE milestone (id INT AUTO_INCREMENT NOT NULL, challenge_id INT DEFAULT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, is_public TINYINT(1) NOT NULL, INDEX IDX_4FAC838298A21AC6 (challenge_id), INDEX IDX_4FAC8382A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE challenge_group (id INT AUTO_INCREMENT NOT NULL, group_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6912CDD777792576 (group_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE challenge (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, is_public TINYINT(1) NOT NULL, is_completed TINYINT(1) NOT NULL, add_proof TINYINT(1) NOT NULL, completed_on DATETIME DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, INDEX IDX_D7098951A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_challenges (challenge_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_A0D2610C98A21AC6 (challenge_id), INDEX IDX_A0D2610CA76ED395 (user_id), PRIMARY KEY(challenge_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE challenge_groups (challenge_id INT NOT NULL, challenge_group_id INT NOT NULL, INDEX IDX_3D09AB198A21AC6 (challenge_id), INDEX IDX_3D09AB1636A3EA7 (challenge_group_id), PRIMARY KEY(challenge_id, challenge_group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE milestone ADD CONSTRAINT FK_4FAC838298A21AC6 FOREIGN KEY (challenge_id) REFERENCES challenge (id)');
        ...
        $this->addSql('ALTER TABLE user_challenges ADD CONSTRAINT FK_A0D2610C98A21AC6 FOREIGN KEY (challenge_id) REFERENCES challenge (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE challenge_groups ADD CONSTRAINT FK_3D09AB198A21AC6 FOREIGN KEY (challenge_id) REFERENCES challenge (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE challenge_groups ADD CONSTRAINT FK_3D09AB1636A3EA7 FOREIGN KEY (challenge_group_id) REFERENCES challenge_group (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE challenge_groups DROP FOREIGN KEY FK_3D09AB1636A3EA7');
        ...
        $this->addSql('ALTER TABLE challenge_groups DROP FOREIGN KEY FK_3D09AB198A21AC6');
